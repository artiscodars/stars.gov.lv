<div class="block p-6 bg-[#f5f5f5]  rounded-lg ">
    ...
    <h5 class="mb-2 text-xl font-medium tracking-tight text-primary dark:text-white leading-6">{{ $title }}</h5>




    <div class="flex flex-col lg:flex-row gap-5 justify-between items-center justify-content-start pt-4">
        <div class="flex-1 font-normal text-[#8A8A8A] text-md">Lorem ipsum dolor sit amet, consectetuer adipiscing
            elit,
            sed diam
